...
export default function EventPage() {
    ...
    useEffect(() => {
        async function checkRegistration() {
            ...
            const isMockRegistered = mockRegistrations.some((reg: any) => reg.userId === user.uid && reg.eventId === id);
            setIsRegistered(isMockRegistered);
        }

        if (user && id) {
            checkRegistration();
        }
    }, [user, id, open, registrationDialogOpen]); // Re-check when dialog opens/closes
